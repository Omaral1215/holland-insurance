...
## Project Structure
    ...
    ├── holland_insurance_g_29700  # Django project configurations
...
1. Clone this repo and `cd holland_insurance_g_29700`
...
2. Clone this repo and `cd holland_insurance_g_29700`
